...
create_clock -name {RX_SPW:RX_B|counter_neg[0]} -period 10.000 -waveform { 0.000 5.000 } [get_registers {RX_SPW:RX_B|counter_neg[0]}]
create_clock -name {RX_SPW:RX|counter_neg[0]} -period 10.000 -waveform { 0.000 5.000 } [get_registers {RX_SPW:RX|counter_neg[0]}]
...
set_clock_uncertainty -rise_from [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[3].output_counter|divclk}] -rise_to [get_clocks {RX_SPW:RX|counter_neg[0]}]  0.300  
set_clock_uncertainty -rise_from [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[3].output_counter|divclk}] -fall_to [get_clocks {RX_SPW:RX|counter_neg[0]}]  0.300  
set_clock_uncertainty -rise_from [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[3].output_counter|divclk}] -rise_to [get_clocks {RX_SPW:RX_B|counter_neg[0]}]  0.300  
set_clock_uncertainty -rise_from [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[3].output_counter|divclk}] -fall_to [get_clocks {RX_SPW:RX_B|counter_neg[0]}]  0.300  
...
set_clock_uncertainty -fall_from [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[3].output_counter|divclk}] -rise_to [get_clocks {RX_SPW:RX|counter_neg[0]}]  0.300  
set_clock_uncertainty -fall_from [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[3].output_counter|divclk}] -fall_to [get_clocks {RX_SPW:RX|counter_neg[0]}]  0.300  
set_clock_uncertainty -fall_from [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[3].output_counter|divclk}] -rise_to [get_clocks {RX_SPW:RX_B|counter_neg[0]}]  0.300  
set_clock_uncertainty -fall_from [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[3].output_counter|divclk}] -fall_to [get_clocks {RX_SPW:RX_B|counter_neg[0]}]  0.300  
...
set_clock_uncertainty -rise_from [get_clocks {FSM_SPW:FSM_B|state_fsm.connecting}] -rise_to [get_clocks {detector_tokens:B|rx_buffer_write}]  0.320  
set_clock_uncertainty -rise_from [get_clocks {FSM_SPW:FSM_B|state_fsm.connecting}] -fall_to [get_clocks {detector_tokens:B|rx_buffer_write}]  0.320  
set_clock_uncertainty -rise_from [get_clocks {FSM_SPW:FSM_B|state_fsm.connecting}] -rise_to [get_clocks {RX_SPW:RX_B|counter_neg[0]}]  0.320  
set_clock_uncertainty -rise_from [get_clocks {FSM_SPW:FSM_B|state_fsm.connecting}] -fall_to [get_clocks {RX_SPW:RX_B|counter_neg[0]}]  0.320  
...
set_clock_uncertainty -fall_from [get_clocks {FSM_SPW:FSM_B|state_fsm.connecting}] -rise_to [get_clocks {detector_tokens:B|rx_buffer_write}]  0.320  
set_clock_uncertainty -fall_from [get_clocks {FSM_SPW:FSM_B|state_fsm.connecting}] -fall_to [get_clocks {detector_tokens:B|rx_buffer_write}]  0.320  
set_clock_uncertainty -fall_from [get_clocks {FSM_SPW:FSM_B|state_fsm.connecting}] -rise_to [get_clocks {RX_SPW:RX_B|counter_neg[0]}]  0.320  
set_clock_uncertainty -fall_from [get_clocks {FSM_SPW:FSM_B|state_fsm.connecting}] -fall_to [get_clocks {RX_SPW:RX_B|counter_neg[0]}]  0.320  
...
set_clock_uncertainty -rise_from [get_clocks {FSM_SPW:FSM|state_fsm.connecting}] -rise_to [get_clocks {RX_SPW:RX|counter_neg[0]}]  0.320  
set_clock_uncertainty -rise_from [get_clocks {FSM_SPW:FSM|state_fsm.connecting}] -fall_to [get_clocks {RX_SPW:RX|counter_neg[0]}]  0.320  
set_clock_uncertainty -rise_from [get_clocks {FSM_SPW:FSM|state_fsm.connecting}] -rise_to [get_clocks {detector_tokens:A|rx_buffer_write}]  0.320  
set_clock_uncertainty -rise_from [get_clocks {FSM_SPW:FSM|state_fsm.connecting}] -fall_to [get_clocks {detector_tokens:A|rx_buffer_write}]  0.320  
...
set_clock_uncertainty -fall_from [get_clocks {FSM_SPW:FSM|state_fsm.connecting}] -rise_to [get_clocks {RX_SPW:RX|counter_neg[0]}]  0.320  
set_clock_uncertainty -fall_from [get_clocks {FSM_SPW:FSM|state_fsm.connecting}] -fall_to [get_clocks {RX_SPW:RX|counter_neg[0]}]  0.320  
set_clock_uncertainty -fall_from [get_clocks {FSM_SPW:FSM|state_fsm.connecting}] -rise_to [get_clocks {detector_tokens:A|rx_buffer_write}]  0.320  
set_clock_uncertainty -fall_from [get_clocks {FSM_SPW:FSM|state_fsm.connecting}] -fall_to [get_clocks {detector_tokens:A|rx_buffer_write}]  0.320  
...
set_clock_uncertainty -rise_from [get_clocks {FPGA_CLK1_50}] -rise_to [get_clocks {detector_tokens:B|rx_buffer_write}] -setup 0.270  
set_clock_uncertainty -rise_from [get_clocks {FPGA_CLK1_50}] -rise_to [get_clocks {detector_tokens:B|rx_buffer_write}] -hold 0.280  
set_clock_uncertainty -rise_from [get_clocks {FPGA_CLK1_50}] -fall_to [get_clocks {detector_tokens:B|rx_buffer_write}] -setup 0.270  
set_clock_uncertainty -rise_from [get_clocks {FPGA_CLK1_50}] -fall_to [get_clocks {detector_tokens:B|rx_buffer_write}] -hold 0.280  
set_clock_uncertainty -rise_from [get_clocks {FPGA_CLK1_50}] -rise_to [get_clocks {detector_tokens:A|rx_buffer_write}] -setup 0.270  
set_clock_uncertainty -rise_from [get_clocks {FPGA_CLK1_50}] -rise_to [get_clocks {detector_tokens:A|rx_buffer_write}] -hold 0.280  
set_clock_uncertainty -rise_from [get_clocks {FPGA_CLK1_50}] -fall_to [get_clocks {detector_tokens:A|rx_buffer_write}] -setup 0.270  
set_clock_uncertainty -rise_from [get_clocks {FPGA_CLK1_50}] -fall_to [get_clocks {detector_tokens:A|rx_buffer_write}] -hold 0.280  
...
set_clock_uncertainty -fall_from [get_clocks {FPGA_CLK1_50}] -rise_to [get_clocks {detector_tokens:B|rx_buffer_write}] -setup 0.270  
set_clock_uncertainty -fall_from [get_clocks {FPGA_CLK1_50}] -rise_to [get_clocks {detector_tokens:B|rx_buffer_write}] -hold 0.280  
set_clock_uncertainty -fall_from [get_clocks {FPGA_CLK1_50}] -fall_to [get_clocks {detector_tokens:B|rx_buffer_write}] -setup 0.270  
set_clock_uncertainty -fall_from [get_clocks {FPGA_CLK1_50}] -fall_to [get_clocks {detector_tokens:B|rx_buffer_write}] -hold 0.280  
set_clock_uncertainty -fall_from [get_clocks {FPGA_CLK1_50}] -rise_to [get_clocks {detector_tokens:A|rx_buffer_write}] -setup 0.270  
set_clock_uncertainty -fall_from [get_clocks {FPGA_CLK1_50}] -rise_to [get_clocks {detector_tokens:A|rx_buffer_write}] -hold 0.280  
set_clock_uncertainty -fall_from [get_clocks {FPGA_CLK1_50}] -fall_to [get_clocks {detector_tokens:A|rx_buffer_write}] -setup 0.270  
set_clock_uncertainty -fall_from [get_clocks {FPGA_CLK1_50}] -fall_to [get_clocks {detector_tokens:A|rx_buffer_write}] -hold 0.280  
...
set_false_path  -from  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[1].output_counter|divclk}]  -to  [get_clocks {FSM_SPW:FSM|state_fsm.*}]
set_false_path  -from  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[0].output_counter|divclk}]  -to  [get_clocks {FSM_SPW:FSM|state_fsm.*}]
set_false_path  -from  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[3].output_counter|divclk}]  -to  [get_clocks {FSM_SPW:FSM|state_fsm.*}]
set_false_path  -from  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[1].output_counter|divclk}]  -to  [get_clocks {FSM_SPW:FSM_B|state_fsm.*}]
set_false_path  -from  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[0].output_counter|divclk}]  -to  [get_clocks {FSM_SPW:FSM_B|state_fsm.*}]
set_false_path  -from  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[3].output_counter|divclk}]  -to  [get_clocks {FSM_SPW:FSM_B|state_fsm.*}]
set_false_path  -from  [get_clocks {FSM_SPW:FSM_B|state_fsm.connecting}]  -to  [get_clocks {FSM_SPW:FSM_B|state_fsm.connecting}]
set_false_path  -from  [get_clocks {FSM_SPW:FSM|state_fsm.connecting}]  -to  [get_clocks {FSM_SPW:FSM|state_fsm.connecting}]
...
set_false_path  -from  [get_clocks {FSM_SPW:FSM|state_fsm.*}]  -to  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[0].output_counter|divclk}]
...
set_false_path  -from  [get_clocks {FPGA_CLK1_50}]  -to  [get_clocks {FSM_SPW:FSM|state_fsm.connecting}]
set_false_path  -from  [get_clocks {FSM_SPW:FSM_B|state_fsm.connecting}]  -to  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[0].output_counter|divclk}]
set_false_path  -from  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[3].output_counter|divclk}]  -to  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[1].output_counter|divclk}]
set_false_path  -from  [get_clocks {FSM_SPW:FSM_B|state_fsm.connecting}]  -to  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[1].output_counter|divclk}]
set_false_path  -from  [get_clocks {FSM_SPW:FSM|state_fsm.connecting}]  -to  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[1].output_counter|divclk}]
set_false_path  -from  [get_clocks {FSM_SPW:FSM_B|state_fsm.connecting}]  -to  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[3].output_counter|divclk}]
set_false_path  -from  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[3].output_counter|divclk}]  -to  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[3].output_counter|divclk}]
...
set_false_path  -from  [get_clocks {FSM_SPW:FSM|state_fsm.connecting}]  -to  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[3].output_counter|divclk}]
set_false_path  -from  [get_clocks {FSM_SPW:FSM_B|state_fsm.connecting}]  -to  [get_clocks {detector_tokens:B|rx_buffer_write}]
set_false_path  -from  [get_clocks {FSM_SPW:FSM_B|state_fsm.connecting}]  -to  [get_clocks {FPGA_CLK1_50}]
set_false_path  -from  [get_clocks {FSM_SPW:FSM|state_fsm.connecting}]  -to  [get_clocks {FPGA_CLK1_50}]
set_false_path  -from  [get_clocks {FSM_SPW:FSM|state_fsm.connecting}]  -to  [get_clocks {detector_tokens:A|rx_buffer_write}]
...
set_false_path  -from  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[0].output_counter|divclk}]  -to  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[1].output_counter|divclk}]
set_false_path  -from  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[1].output_counter|divclk}]  -to  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[0].output_counter|divclk}]
set_false_path  -from  [get_clocks {RX_SPW:RX|counter_neg[0]}]  -to  [get_clocks {FSM_SPW:FSM_B|state_fsm.connecting}]
set_false_path  -from  [get_clocks {RX_SPW:RX_B|counter_neg[0]}]  -to  [get_clocks {FSM_SPW:FSM|state_fsm.connecting}]
set_false_path  -from  [get_clocks {FSM_SPW:FSM_B|state_fsm.connecting}]  -to  [get_clocks {RX_SPW:RX|counter_neg[0]}]
set_false_path  -from  [get_clocks {FSM_SPW:FSM|state_fsm.connecting}]  -to  [get_clocks {RX_SPW:RX_B|counter_neg[0]}]
set_false_path  -from  [get_clocks {RX_SPW:RX|counter_neg[0]}]  -to  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[0].output_counter|divclk}]
set_false_path  -from  [get_clocks {RX_SPW:RX|counter_neg[0]}]  -to  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[1].output_counter|divclk}]
set_false_path  -from  [get_clocks {RX_SPW:RX_B|counter_neg[0]}]  -to  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[0].output_counter|divclk}]
set_false_path  -from  [get_clocks {RX_SPW:RX_B|counter_neg[0]}]  -to  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[1].output_counter|divclk}]
set_false_path  -from  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[3].output_counter|divclk}]  -to  [get_clocks {RX_SPW:RX|counter_neg[0]}]
set_false_path  -from  [get_clocks {AXI_INTERFACE|pll_tx|altera_pll_i|cyclonev_pll|counter[3].output_counter|divclk}]  -to  [get_clocks {RX_SPW:RX_B|counter_neg[0]}]
set_false_path  -from  [get_clocks {RX_SPW:RX_B|counter_neg[0]}]  -to  [get_clocks {FSM_SPW:FSM_B|state_fsm.connecting}]
set_false_path  -from  [get_clocks {RX_SPW:RX|counter_neg[0]}]  -to  [get_clocks {FSM_SPW:FSM|state_fsm.connecting}]
set_false_path  -from  [get_clocks {FSM_SPW:FSM_B|state_fsm.connecting}]  -to  [get_clocks {RX_SPW:RX_B|counter_neg[0]}]
set_false_path  -from  [get_clocks {FSM_SPW:FSM|state_fsm.connecting}]  -to  [get_clocks {RX_SPW:RX|counter_neg[0]}]
set_false_path -from [get_keepers {debounce_db:db_system_spwulight_b|PB_state}] -to [get_registers {RX_SPW:RX|*}]
set_false_path -from [get_keepers {debounce_db:db_system_spwulight_b|PB_state}] -to [get_registers {TX_SPW:TX|*}]
set_false_path -from [get_keepers {debounce_db:db_system_spwulight_b|PB_state}] -to [get_registers {FSM_SPW:FSM|*}]
set_false_path -from [get_keepers {debounce_db:db_system_spwulight_b|PB_state}] -to [get_registers {RX_SPW:RX_B|*}]
set_false_path -from [get_keepers {debounce_db:db_system_spwulight_b|PB_state}] -to [get_registers {TX_SPW:TX_B|*}]
set_false_path -from [get_keepers {debounce_db:db_system_spwulight_b|PB_state}] -to [get_registers {FSM_SPW:FSM_B|*}]
...
set_false_path -from [get_keepers {debounce_db:db_system_spwulight_a|PB_state}] -to [get_registers {RX_SPW:RX|*}]
set_false_path -from [get_keepers {debounce_db:db_system_spwulight_a|PB_state}] -to [get_registers {TX_SPW:TX|*}]
set_false_path -from [get_keepers {debounce_db:db_system_spwulight_a|PB_state}] -to [get_registers {FSM_SPW:FSM|*}]
set_false_path -from [get_keepers {debounce_db:db_system_spwulight_a|PB_state}] -to [get_registers {RX_SPW:RX_B|*}]
set_false_path -from [get_keepers {debounce_db:db_system_spwulight_a|PB_state}] -to [get_registers {TX_SPW:TX_B|*}]
set_false_path -from [get_keepers {debounce_db:db_system_spwulight_a|PB_state}] -to [get_registers {FSM_SPW:FSM_B|*}]
